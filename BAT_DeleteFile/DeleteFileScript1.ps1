...
# ●ファイル削除
$DelFilePaths = @(
    "C:\Users\meviu\Desktop\TOOL\BAT_DeleteFile\newFolder\新しいフォルダー1\FILE1.txt"
    , "C:\Users\meviu\Desktop\TOOL\BAT_DeleteFile\newFolder\新しいフォルダー1\FILE2.txt"
)
# ●フォルダ内だけ削除
$DelContentsPaths = @(
    "C:\Users\meviu\Desktop\TOOL\BAT_DeleteFile\newFolder\新しいフォルダー2\新しいフォルダー2-1"
    , "C:\Users\meviu\Desktop\TOOL\BAT_DeleteFile\newFolder\新しいフォルダー3\新しいフォルダー3-1"
)
# ●フォルダごと削除
$DelFolderPaths = @(
    "C:\Users\meviu\Desktop\TOOL\BAT_DeleteFile\newFolder\新しいフォルダー4"
