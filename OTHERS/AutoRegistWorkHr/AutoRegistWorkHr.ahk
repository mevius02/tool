...
;; 勤務(開始/終了)時間
;; 休憩(開始/終了)時間
startWork := ["9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00",
    "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00", "9:00",
    "9:00", "9:00", "9:00", "9:00"]
endWork := ["18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00",
    "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00", "18:00",
    "18:00", "18:00", "18:00", "18:00", "18:00", "18:00"]
startRest := ["12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00",
    "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00",
    "12:00", "12:00", "12:00", "12:00", "12:00", "12:00", "12:00"]
endRest := ["13:00", "13:00", "13:00", "13:00", "13:00", "13:00", "13:00", "13:00", "13:00", "13:00", "13:00", "13:00",
...
F1:: {
    ...
    ;; 1か月の日数分Loop
    loop dayCnt {
        ;; 勤務(開始/終了)どちらか未入力の場合、登録しない
        if (startWork[A_Index] == "" or endWork[A_Index] == "") {
            continue
        }
        ;; 10行単位で入力繰り返しの場合
        if (row10Flg) {
        ...
        if (tgtColor != holidayColor1 and tgtColor != holidayColor2) {
            ...
            loop 120 {
                ...
                Send("^a{Backspace}")
                Sleep(50) ;; 0.05秒
                Send("{Text}" startWork[idx])
                Sleep(50) ;; 0.05秒
                Send("^a^c")
                ;; コピー可否 判定
                if ClipWait(0.05) {
                    ;; 入力した文字列と一致する場合(入力欄にコピペできた場合)
                    if (A_Clipboard == startWork[idx]) {
                        success := true
                        break
                    }
                }
            ...
            if (clearFlg) {
                ...
                ;; TAB移動 → 勤務終了
                Send("{Tab}")
                Send("{Text}" endWork[A_Index])
                ;; TAB移動 → 休憩開始
                Send("{Tab}")
                Send("{Text}" startRest[A_Index])
                ;; TAB移動 → 休憩終了
                Send("{Tab}")
                Send("{Text}" endRest[A_Index])
                ;; TAB移動 → 登録ボタン
                loop 9 {
                    Send("{Tab}")
                }
